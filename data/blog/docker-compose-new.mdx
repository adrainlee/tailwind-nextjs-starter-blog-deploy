...
```bash
{ echo '#!/bin/bash'; echo 'docker compose { echo '#!/bin/bash'; echo 'docker compose "$@"'; } | sudo tee /bin/docker-compose >/dev/null && sudo chmod +x /bin/docker-compose
 "$@"'; } | sudo tee /bin/docker-compose >/dev/null && sudo chmod +x /bin/docker-compose
```
